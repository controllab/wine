 ...
 */
void WINAPI wine_gluBeginPolygon(void *arg0) {
    get_opengl_funcs()->glu.p_gluBeginPolygon(arg0);
}

/***********************************************************************
 *      gluEndPolygon (GLU32.@)
 */
void WINAPI wine_gluEndPolygon(void *arg0) {
    get_opengl_funcs()->glu.p_gluEndPolygon(arg0);
}

/***********************************************************************
 *      gluNextContour (GLU32.@)
 */
void WINAPI wine_gluNextContour(void *arg0,int arg1) {
    get_opengl_funcs()->glu.p_gluNextContour(arg0,arg1);
}
